...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAllProducts() async {
    try {
      final response =
          await http.get(Uri.parse(API.products + "?auth=$_token"));
      print(response.body);
      ...
      final favouriteResponse = await http.get(
          Uri.parse(API.toggleFavourite + "$_userId.json" + "?auth=$_token"));
  ...
  Future<void> addProduct(Product addProduct, File imageFile) async {
    ...
    try {
      ...
      final response = await http.post(
          Uri.parse(API.products + "?auth=$_token"),
  ...
  Future<void> updateProduct(String id, Product updatedProduct,
    ...
    try {
      ...
      final response = await http.patch(
          Uri.parse(API.baseUrl + "/products/$id.json" + "?auth=$_token"),
  ...
  Future<void> deleteProduct(String productId) async {
    try {
      ...
      final response = await http.delete(Uri.parse(
          API.baseUrl + "/products/$productId.json" + "?auth=$_token"));
